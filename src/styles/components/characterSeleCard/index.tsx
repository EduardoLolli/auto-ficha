...
const StyledCharacterSeleCard = styled("div")`
...
#webcrumbs .hover\:bg-amber-600:hover {
  --tw-bg-opacity: 1;
...
#webcrumbs .hover\:shadow-indigo-700\/50:hover {
  --tw-shadow-color: rgba(67, 56, 202, 0.5);
  --tw-shadow: var(--tw-shadow-colored);
}
#webcrumbs .hover\:shadow-purple-700\/50:hover {
  --tw-shadow-color: rgba(126, 34, 206, 0.5);
  --tw-shadow: var(--tw-shadow-colored);
}
...
#webcrumbs :is(.group:hover .group-hover\:bg-amber-600) {
  --tw-bg-opacity: 1;
  background-color: rgb(217 119 6 / var(--tw-bg-opacity));
}
@media (min-width: 640px) {
  ...
  #webcrumbs :is(.sm\:space-x-4 > :not([hidden]) ~ :not([hidden])) {
    --tw-space-x-reverse: 0;
    margin-left: calc(16px * (1 - var(--tw-space-x-reverse)));
    margin-right: calc(16px * var(--tw-space-x-reverse));
  }
  #webcrumbs :is(.sm\:space-y-0 > :not([hidden]) ~ :not([hidden])) {
    --tw-space-y-reverse: 0;
...
export default StyledCharacterSeleCard