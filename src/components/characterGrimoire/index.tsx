            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div className="flex flex-col justify-between bg-indigo-800 bg-opacity-50 rounded-lg p-3 border border-indigo-600 hover:border-purple-500 hover:bg-indigo-800 transition-all h-24">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-purple-300 font-bold text-xl">15</span>
                </div>
                <div className="mt-2">
              ...
              <div className="flex flex-col justify-between bg-indigo-800 bg-opacity-50 rounded-lg p-3 border border-indigo-600 hover:border-purple-500 hover:bg-indigo-800 transition-all h-24">
                <div className="flex items-center justify-between">
                  <span className="text-white font-medium">Energia Arcana</span>
                  <span className="text-blue-300 font-bold text-xl">65/70</span>
                </div>
                <div className="mt-2">
                  <div className="flex justify-between text-xs text-indigo-100 mb-1">
            ...
            <div className="grid grid-cols-1 gap-3">
              <div className="group relative p-3 bg-purple-800 bg-opacity-40 rounded-lg border border-purple-600 transition-all flex justify-between items-center">
                ...
                <div className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gray-900 bg-opacity-95 text-white p-3 rounded-lg shadow-lg w-64 right-0 top-full mt-2 z-10 pointer-events-none">
                  ...
                  <p className="text-sm mb-2">
                    Você lança um projétil de fogo que causa 1d10 de dano. Para
                    cada slot adicional, você pode criar um dardo extra.
                  </p>
                  ...
                  <p className="text-xs text-purple-300">Componentes: V, S</p>
                </div>
              </div>
              ...
              <div className="group relative p-3 bg-purple-800 bg-opacity-40 rounded-lg border border-purple-600 transition-all flex justify-between items-center">
                ...
                <div className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gray-900 bg-opacity-95 text-white p-3 rounded-lg shadow-lg w-64 right-0 top-full mt-2 z-10 pointer-events-none">
                  ...
                  <p className="text-sm mb-2">
                    Um campo de força protetora envolve você, garantindo +3 na
                    CA pelo resto do dia.
                  </p>
                  <p className="text-xs text-purple-300 mb-1">
                    Tempo de Conjuração: 1 ação
                  </p>
              ...
              <div className="group relative p-3 bg-indigo-800 bg-opacity-40 rounded-lg border border-indigo-600 hover:border-purple-500 hover:bg-indigo-800 hover:bg-opacity-50 transition-all flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-indigo-300">Evocação - Truque</p>
                  </div>
                </div>
                <div className="flex items-center">
                ...
                <div className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gray-900 bg-opacity-95 text-white p-3 rounded-lg shadow-lg w-64 right-0 top-full mt-2 z-10 pointer-events-none">
                  ...
                  <p className="text-sm mb-2">
                    ...
                    qualquer dimensão, fazendo-o emitir luz brilhante em um raio
                    de 6 metros.
                  </p>
                  <p className="text-xs text-blue-300 mb-1">
                    Tempo de Conjuração: 1 ação
                  </p>
                  <p className="text-xs text-blue-300 mb-1">Duração: 1 hora</p>
            ...
            <div className="grid grid-cols-1 gap-3">
              <div className="group relative p-3 bg-indigo-800 bg-opacity-40 rounded-lg border border-indigo-600 hover:border-purple-500 hover:bg-indigo-800 hover:bg-opacity-50 transition-all flex justify-between items-center">
                ...
                <div className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gray-900 bg-opacity-95 text-white p-3 rounded-lg shadow-lg w-64 right-0 top-full mt-2 z-10 pointer-events-none">
                  ...
                  <p className="text-sm mb-2">
                    Você cria um efeito mágico menor como colorir ou limpar um
                    objeto, criar um sensação sensorial inofensiva, acender ou
                    apagar uma vela, etc.
                  </p>
                  <p className="text-xs text-purple-300 mb-1">
                    Tempo de Conjuração: 1 ação
              ...
              <div className="group relative p-3 bg-indigo-800 bg-opacity-40 rounded-lg border border-indigo-600 hover:border-purple-500 hover:bg-indigo-800 hover:bg-opacity-50 transition-all flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <div>
                    <span className="text-white font-medium">Mãos Mágicas</span>
                    <p className="text-xs text-indigo-300">
                      Conjuração - Truque
                    </p>
                  </div>
                ...
                <div className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gray-900 bg-opacity-95 text-white p-3 rounded-lg shadow-lg w-64 right-0 top-full mt-2 z-10 pointer-events-none">
                  ...
                  <p className="text-sm mb-2">
                    Uma mão espectral flutuante aparece num ponto à sua escolha
                    dentro do alcance. A mão dura pela duração ou até você
                    dissipá-la.
                  </p>
                  <p className="text-xs text-purple-300 mb-1">
                    Tempo de Conjuração: 1 ação
              ...
              <div className="group relative p-3 bg-indigo-800 bg-opacity-40 rounded-lg border border-indigo-600 hover:border-purple-500 hover:bg-indigo-800 hover:bg-opacity-50 transition-all flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-indigo-300">Ilusão - Nível 1</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <button className="text-white bg-green-700 hover:bg-green-600 rounded px-3 py-1 flex items-center">
                ...
                <div className="absolute opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gray-900 bg-opacity-95 text-white p-3 rounded-lg shadow-lg w-64 right-0 top-full mt-2 z-10 pointer-events-none">
                  ...
                  <p className="text-sm mb-2">
                    Você cria a imagem ilusória de um objeto, uma criatura ou
                    algum outro fenômeno visível que não seja maior que um cubo
                    de 4,5 metros.
                  </p>
                  <p className="text-xs text-purple-300 mb-1">
                    Tempo de Conjuração: 1 ação
