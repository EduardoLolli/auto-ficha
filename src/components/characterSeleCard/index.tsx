...
const CharacterSeleCard = ({ character }: ICharacter) => {
  return (
    <StyledCharacterSeleCard className="bg-gray-900 bg-opacity-70 rounded-lg overflow-hidden border-2 border-indigo-700 hover:border-amber-500 transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-purple-700/50 group">
